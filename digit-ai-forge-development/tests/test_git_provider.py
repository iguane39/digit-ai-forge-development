...
def test_parse_azdo_remote_dev_azure() -> None:
    assert parse_azdo_remote("https://dev.azure.com/Client-A-DevOps/APP-IA/_git/repo") == (
        "https://dev.azure.com/Client-A-DevOps",
        "APP-IA",
        "repo",
    )
...
def test_parse_azdo_remote_accented_repo_urlencoded() -> None:
    ...
    url = "https://dev.azure.com/Client-A-DevOps/APP-IA/_git/IAC_Plateforme_Vid%C3%A9o_IA_Enseigne-A"
    assert parse_azdo_remote(url) == (
        "https://dev.azure.com/Client-A-DevOps",
        "APP-IA",
        "IAC_Plateforme_Vidéo_IA_Enseigne-A",
    )
